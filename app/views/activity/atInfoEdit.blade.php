...
@if($viewType == 'add')
{{ Form::open(array('action'    =>  array('ActivityController@postEditInfo'),'method'  =>  'post','class'=>'container form-horizontal','role'=>'form')) }}
@else
{{ Form::open(array('action'    =>  array('ActivityController@postEditInfo',$data->id),'method'  =>  'post','class'=>'container form-horizontal','role'=>'form')) }}
@endif
