...
<div class="ui-btn-group ui-btn-group-bottom">
    <button type="button" targetUrl="#">
       <i class="fa fa-list"></i> 新闻
    </button>
    <button type="button" targetUrl="{{ URL::action('mobile\VolunteerController@atLatest') }}">
        <i class="fa fa-leaf"></i>
        活动
    </button>
    <button type="button" targetUrl="{{ URL::action('mobile\VolunteerController@index') }}">
...
!function($) {
    $(document).ready(function() {
        $('.ui-btn-group button').on('tap', function() {
