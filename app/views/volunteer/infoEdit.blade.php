...
@endif
        ...
        <div class="form-group form-group-material-amber">
          ...
          <div class="col-sm-10">
            <textarea  class="form-control" name="attr_extra" id="" cols="30" rows="5">
        ...
        <div class="form-group form-group-material-amber">
          ...
          <div class="col-sm-10">
            <select class="form-control" name="is_must" id="is_must">
        ...
        {{ Form::label('','',array('class'    =>  'col-sm-2 control-label'))  }}
          <div class="col-sm-10">
            <button type="submit" class="btn btn-material-amber" onclick="javascript:void(null);">
